...
const editorStyles = `
  ...
  /* Editing UI cue for elements tagged as full width */
...
// Extension to allow elements (like paragraphs) to break out of columns
...
export default function FormattingTool() {
  ...
  const uploadImageNative = async (files: File[]) => {
    ...
    try {
      ...
      // Ensure file input is reset so same files can be re-picked
